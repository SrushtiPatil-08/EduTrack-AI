...
import { z } from 'zod';
import { GraduationCap, ArrowLeft, AlertCircle, ArrowRight, CheckCircle2 } from 'lucide-react';
        ...
        <div className="glass rounded-3xl p-8">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              ...
              <p className="text-sm text-text-muted">Start mastering your campus today</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="flex items-center gap-4 text-xs text-text-muted">
              <span className="flex items-center gap-1.5"><CheckCircle2 size={12} className="text-primary" /> 6+ chars</span>
              <span className="flex items-center gap-1.5"><CheckCircle2 size={12} className="text-primary" /> No verification</span>
            </div>
            ...
            {countdown !== null && (
              <p className="text-xs text-text-muted">Redirecting to login in {countdown}s…</p>
            )}
